...
//        initBugly(app);
    ...
    public static String  CopySqliteFileFromRawToDatabases(String SqliteFileName) throws IOException {
        ...
        File dir = new File("data/data/" + YanshiApp.getApplication().getPackageName() + "/databases");
        ...
        if (!file.exists()) {
            try {
                ...
                inputStream = YanshiApp.getApplication().getClass().getClassLoader().getResourceAsStream("assets/" + SqliteFileName);
    ...
    private static void initBugly(Application application) {
        ...
        /***** 统一初始化Bugly产品，包含Beta *****/
        Bugly.init(application, APP_ID, true, strategy);
    }
