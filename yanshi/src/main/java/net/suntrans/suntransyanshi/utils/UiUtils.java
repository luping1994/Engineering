...
import net.suntrans.suntransyanshi.YanshiApp;
...
public class UiUtils {
	...
	public static void showToast(String str) {
		if (mToast == null) {
			mToast = Toast.makeText(YanshiApp.getApplication(), str, Toast.LENGTH_SHORT);
		}
		mToast.setText(str);
		mToast.show();
	}
	...
	public static Resources getResource1() {
		return YanshiApp.getApplication().getResources();
	}
	...
	public static Context getContext() {
		return YanshiApp.getApplication();
	}
